...
//        primaryStage.getIcons().add(new Image("/images/icon.jpg"));
    ...
    public static FXMLLoader getFXMLLoader() {
        ResourceBundle resourceBundle = ResourceBundle.getBundle("locale.BullsAndCowsGame");
        URL url = Object.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/games/BullsAndCowsGame.fxml");
