...
public class petMain extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        FXMLLoader fXMLLoader = petMain.getFXMLLoader();
...
//        primaryStage.getIcons().add(new Image("/images/icon.jpg"));
    ...
    public static FXMLLoader getFXMLLoader() {
        ResourceBundle resourceBundle = ResourceBundle.getBundle("locale.pet");
        URL url = Object.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/games/pet.fxml");
