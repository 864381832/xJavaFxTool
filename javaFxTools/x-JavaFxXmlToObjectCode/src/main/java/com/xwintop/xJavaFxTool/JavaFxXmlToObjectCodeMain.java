...
@Slf4j
public class JavaFxXmlToObjectCodeMain extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        FXMLLoader fXMLLoader = JavaFxXmlToObjectCodeMain.getFXMLLoader();
...
//        primaryStage.getIcons().add(new Image("/images/icon.jpg"));
    ...
    public static FXMLLoader getFXMLLoader() {
        ResourceBundle resourceBundle = ResourceBundle.getBundle("locale.JavaFxXmlToObjectCode");
