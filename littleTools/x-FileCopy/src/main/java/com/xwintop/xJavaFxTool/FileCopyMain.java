...
public class FileCopyMain extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        FXMLLoader fXMLLoader = FileCopyMain.getFXMLLoader();
...
//        primaryStage.getIcons().add(new Image("/images/icon.jpg"));
    ...
    public static FXMLLoader getFXMLLoader() {
        ResourceBundle resourceBundle = ResourceBundle.getBundle("locale.FileCopy");
        URL url = Object.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/littleTools/FileCopy.fxml");
