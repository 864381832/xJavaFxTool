...
@Slf4j
public class RelationshipCalculatorMain extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        FXMLLoader fXMLLoader = RelationshipCalculatorMain.getFXMLLoader();
...
//        primaryStage.getIcons().add(new Image("/images/icon.jpg"));
    ...
    public static FXMLLoader getFXMLLoader() {
        ResourceBundle resourceBundle = ResourceBundle.getBundle("locale.RelationshipCalculator");
        URL url = Object.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/littleTools/RelationshipCalculator.fxml");
