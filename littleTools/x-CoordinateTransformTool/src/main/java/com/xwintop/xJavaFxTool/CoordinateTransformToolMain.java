...
@Slf4j
public class CoordinateTransformToolMain extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        FXMLLoader fXMLLoader = CoordinateTransformToolMain.getFXMLLoader();
...
//        primaryStage.getIcons().add(new Image("/images/icon.jpg"));
    ...
    public static FXMLLoader getFXMLLoader() {
        ...
        URL url = Object.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/littleTools/CoordinateTransformTool.fxml");
