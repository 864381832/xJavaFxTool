...
@Slf4j
public class EncryptAndDecryptMain extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        FXMLLoader fXMLLoader = EncryptAndDecryptMain.getFXMLLoader();
...
//        double[] screenSize = JavaFxSystemUtil.getScreenSizeByScale(0.74D, 0.8D);
    ...
    public static FXMLLoader getFXMLLoader() {
        ...
        URL url = Object.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/littleTools/EncryptAndDecrypt.fxml");
