...
#### 项目简介：
ZHConverter是使用javafx开发的一款字符串转换工具，实现拼音、简体-繁体、简体-臺灣正體、简体-香港繁體、繁體-臺灣正體、繁體-香港繁體、香港繁體-臺灣正體、数字金额-大写金额等直接的转换。使用[hanlp](http://hanlp.com/)开源工具包。
...
![字符串转换工具.png](images/字符串转换工具.png)
![字符串转换工具.gif](images/字符串转换工具.gif)