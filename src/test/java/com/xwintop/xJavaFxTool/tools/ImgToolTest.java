 ...
 * @author zhangheng
 */
public class ImgToolTest{
    
    protected BufferedImage image;
    protected String type;
    protected boolean alphaed;
    protected ImgToolTest(){
    ...
    public ImgToolTest(String path) throws IOException{
        this(open(path));
    }
    public ImgToolTest(InputStream path) throws IOException{
        this(path, null);
    }
    public ImgToolTest(InputStream path, String type) throws IOException{
        if(path==null){
            throw new IOException("path is null");
        }
     ...
     * @return
     */
    public ImgToolTest flip(boolean isHorizontal) {
     ...
     * @return
     */
    public ImgToolTest resize(int size){
     ...
     * @return
     */
    public ImgToolTest resize(int width, int height){
     ...
     * @return
     */
    public ImgToolTest thumbnail(int size){
     ...
     * @return
     */
    public ImgToolTest thumbnail(int width, int height){
     ...
     * @return
     */
    public ImgToolTest square(boolean small){
        int w = width();
        int h = height();
        if(w!=h){
     ...
     * @return
     */
    public ImgToolTest corner(int radius){
     ...
     * @return
     */
    public ImgToolTest corner(float percent){
        if(percent>360){
            percent = percent%360;
        }
        if(percent>1){
     ...
     * @return
     */
    public ImgToolTest cut(int x, int y, int width, int height){
        image = image.getSubimage(x, y, width, height);
        return this;
    }
    public ImgToolTest save(String path) throws IOException{
        String format = type==null?"jpg":type;
        return save(path, format);
    }
    public ImgToolTest save(String path, String format) throws IOException{
        if(alphaed){
            format = "png";
        }
    ...
    public ImgToolTest save(OutputStream path) throws IOException{
        String format = type==null?"jpg":type;
        return save(path, format);
    }
    public ImgToolTest save(OutputStream path, String format) throws IOException{
        if(alphaed){
            format = "png";
        }
     ...
     * @return
     */
    public ImgToolTest rotate(double degree) {
    ...
    public ImgToolTest draw(BufferedImage img, Align align){
        return this.draw(img, align, 0.0d);
    }
    public ImgToolTest draw(BufferedImage img){
        return this.draw(img, Align.BOTTOM_RIGHT, 0);
    }
    public ImgToolTest draw(BufferedImage img, Align align, int offset){
        return this.draw(img, align, 0.0d, offset, 1.0f);
    }
    public ImgToolTest draw(BufferedImage img, Align align, Double degree){
        return this.draw(img, align, degree, 0, 1.0f);
    }
    public ImgToolTest draw(BufferedImage img, Align align, Double degree, int offset, float alpha){
        return draw(img, align, degree, offset, offset, alpha);
    }
    public ImgToolTest draw(String imgPath, Align align) throws IOException{
        return this.draw(ImageIO.read(new File(imgPath)), align);
    }
    public ImgToolTest draw(String imgPath) throws IOException{
        return this.draw(ImageIO.read(new File(imgPath)));
    }
    public ImgToolTest draw(String imgPath, Align align, Double degree, int offsetX, int offsetY, float alpha) throws IOException{
     ...
     * @return
     */
    public ImgToolTest draw(BufferedImage img, Align align, Double degree, int offsetX, int offsetY, float alpha){
