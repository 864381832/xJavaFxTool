...
public class SealUtil {
    ...
    public static class SealFont {
        ...
        private String fontFamily;//字形名，默认为宋体
        ...
        public String getFontFamily() {
            return fontFamily == null ? "宋体" : fontFamily;
        }

        public boolean getIsBold() {
            return isBold == null ? true : isBold;
        }
    ...
    public boolean drawToFile(String pngPath) throws Exception {
