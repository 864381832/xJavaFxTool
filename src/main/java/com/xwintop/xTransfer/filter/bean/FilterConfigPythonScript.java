...
/**
 * @ClassName: FilterConfigPythonScript
 * @Description: 执行Python脚本配置
 * @author: xufeng
 * @date: 2019/5/14 9:55
 */

@Data
public class FilterConfigPythonScript implements FilterConfig {
    private String serviceName = "filterPythonScript";//对应服务名称
