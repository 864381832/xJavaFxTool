...
/**
 * @ClassName: FilterConfigLuaScript
 * @Description: 执行Lua脚本配置
 * @author: xufeng
 * @date: 2019/5/14 9:55
 */

@Data
public class FilterConfigLuaScript implements FilterConfig {
    private String serviceName = "filterLuaScript";//对应服务名称
