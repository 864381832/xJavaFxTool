...
import com.easipass.gateway.route.enums.EmailMethod;
import lombok.Data;
...
public class ReceiverConfigEmail implements ReceiverConfig {
    ...
    private List<ReceiverConfigEmailRow> receiverConfigEmailList = new ArrayList<>();

    @Data
    public static class ReceiverConfigEmailRow implements Serializable {
