...
public class ExpressionParserToolTableBean {
	...
	public ExpressionParserToolTableBean(String order, Boolean isEnabled, String script, String type, String parameter,
	...
	public ExpressionParserToolTableBean(String propertys) {
