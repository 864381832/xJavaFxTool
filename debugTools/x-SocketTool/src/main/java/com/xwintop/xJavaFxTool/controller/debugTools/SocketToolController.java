...
public class SocketToolController extends SocketToolView {
    ...
    private String[] autoReplyTypeStrings = new String[]{"接收的数据", "写入的数据"};
    ...
    private void initView() throws Exception {
        autoReplyTypeChoiceBox.getItems().addAll(autoReplyTypeStrings);
        autoReplyTypeChoiceBox.setValue(autoReplyTypeStrings[0]);
        ...
        JavaFxViewUtil.setPasswordTextFieldFactory(serverKeyStorePasswordTextField);
        JavaFxViewUtil.setPasswordTextFieldFactory(serverTrustStorePasswordTextField);
        JavaFxViewUtil.setPasswordTextFieldFactory(clientKeyStorePasswordTextField);
        JavaFxViewUtil.setPasswordTextFieldFactory(clientTrustStorePasswordTextField);
    }
