...
/**
 * @ClassName: CmdToolTableBean
 * @Description: Cmd调试工具表bean
 * @author: xufeng
 * @date: 2017年10月26日 上午9:22:44
 */
public class CmdToolTableBean {
	...
	public CmdToolTableBean(String order, Boolean isEnabled, String script, String type, String parameter,
	...
	public CmdToolTableBean(String propertys) {
