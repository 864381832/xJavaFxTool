...
public class ActiveMqToolController extends ActiveMqToolView {
    ...
    private AbstractMap.SimpleImmutableEntry<String, Integer>[] receiverAcknowledgeModeChoiceBoxValues = new AbstractMap.SimpleImmutableEntry[]{
        new AbstractMap.SimpleImmutableEntry<>("SESSION_TRANSACTED", Session.SESSION_TRANSACTED),
        new AbstractMap.SimpleImmutableEntry<>("AUTO_ACKNOWLEDGE", Session.AUTO_ACKNOWLEDGE),
        new AbstractMap.SimpleImmutableEntry<>("CLIENT_ACKNOWLEDGE", Session.CLIENT_ACKNOWLEDGE),
        new AbstractMap.SimpleImmutableEntry<>("DUPS_OK_ACKNOWLEDGE", Session.DUPS_OK_ACKNOWLEDGE),
        new AbstractMap.SimpleImmutableEntry<>("INDIVIDUAL_ACKNOWLEDGE", ActiveMQSession.INDIVIDUAL_ACKNOWLEDGE)};
    ...
    private void initView() {
        ...
        sendNumberTableColumn.setCellValueFactory(new PropertyValueFactory<ActiveMqToolTableBean, String>("sendNumber"));
        ...
        messageTypeTableColumn.setCellValueFactory(new PropertyValueFactory<ActiveMqToolTableBean, String>("messageType"));
        ...
        isRequiredReplyTableColumn.setCellValueFactory(new PropertyValueFactory<ActiveMqToolTableBean, Boolean>("isRequiredReply"));
    ...
    private void initReceiverView() {
        ...
        receiverMessageIDTableColumn.setCellValueFactory(new PropertyValueFactory<>("messageID"));
        receiverQueueTableColumn.setCellValueFactory(new PropertyValueFactory<>("queue"));
        receiverMessageTableColumn.setCellValueFactory(new PropertyValueFactory<>("message"));
        receiverMessageTypeTableColumn.setCellValueFactory(new PropertyValueFactory<>("messageType"));
        receiverTimestampTableColumn.setCellValueFactory(new PropertyValueFactory<>("timestamp"));
        receiverIsAcknowledgeTableColumn.setCellValueFactory(new PropertyValueFactory<>("isAcknowledge"));
        receiverIsAcknowledgeTableColumn.setCellFactory(CheckBoxTableCell.forTableColumn(receiverIsAcknowledgeTableColumn));
