...
#### 项目简介：
RedisTool是一款使用javafx开发的redis连接工具，完成redis的基本增删改查功能，(使用[jedis](https://github.com/xetorthio/jedis)工具类)
...
![Redis连接工具.png](images/Redis连接工具.png)
![Redis连接工具.gif](images/Redis连接工具.gif)
