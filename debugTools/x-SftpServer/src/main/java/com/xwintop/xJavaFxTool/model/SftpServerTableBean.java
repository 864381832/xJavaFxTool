...
public class SftpServerTableBean {
	...
	public SftpServerTableBean(Boolean isEnabled, String userName, String password, String homeDirectory, Boolean downFIle, Boolean upFile,
                               Boolean deleteFile) {
		super();
	...
	public SftpServerTableBean(String propertys) {
